      ...
      <section style={styles.shell}>
        <aside style={styles.brandPanel}>
          ...
          <div style={styles.brandContent}>
            <p style={styles.brandEyebrow}>START BUILDING</p>

            <h1 style={styles.brandHeading}>
              Turn business activity into a clear, repeatable system.
            </h1>

            <p style={styles.brandDescription}>
              Create your workspace and bring your leads, pipeline,
              appointments, and daily operations together.
            </p>

            <div style={styles.featureList}>
              <Feature
                icon={<UsersRound size={18} />}
                title="Manage every opportunity"
                text="Keep leads, notes, and next steps organized."
              />

              <Feature
                icon={<BarChart3 size={18} />}
                title="Build a visible sales process"
                text="Move opportunities through a focused pipeline."
              />

              <Feature
                icon={<ShieldCheck size={18} />}
                title="Start with a secure workspace"
                text="Your account is protected from the beginning."
              />
            </div>
          </div>
        ...
        <section style={styles.formPanel}>
          ...
          <div style={styles.formContainer}>
            <div style={styles.formHeader}>
              ...
              <p style={styles.formEyebrow}>CREATE YOUR WORKSPACE</p>
              ...
              <p style={styles.formDescription}>
                Organize leads, manage your pipeline, and run your business from
            ...
            <p style={styles.termsText}>
              By creating an account, you agree to use Techuvo Flow responsibly
              and securely.
            </p>
          </div>
        </section>
    ...
    <div style={styles.previewWrap}>
      <div style={styles.previewCard}>
        <div style={styles.previewHeader}>
          <div>
            <p style={styles.previewEyebrow}>WORKSPACE PREVIEW</p>
            <p style={styles.previewTitle}>Your business at a glance</p>
          </div>
        ...
        <div style={styles.metricGrid}>
          <div style={styles.metricCard}>
            <span style={styles.metricLabel}>Active leads</span>
            <strong style={styles.metricValue}>38</strong>
            <span style={styles.metricChange}>8 need follow-up</span>
          </div>

          <div style={styles.metricCard}>
            <span style={styles.metricLabel}>Pipeline value</span>
            <strong style={styles.metricValue}>$8.4k</strong>
            <span style={styles.metricChange}>Across 12 opportunities</span>
          </div>
        </div>
        ...
        <div style={styles.activityCard}>
          ...
          <div style={styles.activityContent}>
            ...
            <span style={styles.activityText}>
              Leads, appointments, and activity in one workspace
            </span>
          </div>
        </div>
      </div>
      ...
      <div style={styles.floatingCard}>
        ...
        <div>
          <strong style={styles.floatingTitle}>Workspace ready</strong>
          <span style={styles.floatingText}>Built around your business</span>
        </div>
      </div>
    </div>
  );
